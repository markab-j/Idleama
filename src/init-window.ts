import {currentMonitor, getCurrentWindow, Monitor, PhysicalSize} from '@tauri-apps/api/window';
import { moveWindow, Position } from "@tauri-apps/plugin-positioner";

export async function initWindow(): Promise<Pick<Monitor, 'size' | 'scaleFactor'>> {
